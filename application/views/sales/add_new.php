                                        ...
                                        <table class="table" >
                                            ...
                                            <tr>
                                                <th colspan="2">                 <div class="form-group input-group" style="width:100%;">
                                                        ...
                                                        <input type="text" class="form-control" id="customer_id" name="vendor_id" required value="<?= $user_no; ?>" onblur="getUserDetail(this.value);" >
                                            ...
                                            <tr>
                                                <th colspan="2">                 <div class="form-group input-group" style="width:100%;">
                                                        ...
                                                        <input type="text" class="form-control" id="customer_full_name" name="customer_full_name" required value="" >
                                                ...
                                                <th>
                                                    <div class="form-group input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="customer_contact" name="customer_contact" value=""  >
