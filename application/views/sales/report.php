...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            SALES REPORT
            <small style="color: #fff;">Complete sales report with interactive graphs</small>
        </h1>
    </section>
                    ...
                    <div class="col-md-12">
                        <div class="info-box bg-green">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"><?= $total_sales->general_journal_credit; ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-box bg-red">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"><?= $discount_allowed->general_journal_debit; ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-box bg-yellow">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"><?= $sales_receivable->sales_receivable ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="info-box bg-aqua">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"><?= $open_inv_balance ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    </div>
